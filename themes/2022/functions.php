...
?>
    ...
    <div class="wpf-post-stat">
        ...
        <div class="wpf-post-stat-box">
            <span class="wpf-tstat">
                <svg style="height: 17px;" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1">
        ...
        <div class="wpf-post-stat-box wpf-pb-more" wpf-tooltip="<?php wpforo_phrase('Topic overview and more...') ?>" wpf-tooltip-size="middle">
            ...
            <span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="30" height="30">
...
{
?>
    <div class="wpforo-topic-head-wrap" data-forumid="<?php echo intval($forum['forumid']) ?>" data-topicid="<?php echo wpforo_bigintval($topic['topicid']) ?>" data-userid="<?php echo wpforo_bigintval($topic['userid']) ?>" data-isowner="<?php echo intval((wpforo_bigintval($topic['userid']) === WPF()->current_userid)) ?>">
...
function wpforo_l2_print_avatars($userids, $ucount)
{
...
{
    $ulimit = (int) apply_filters('wpforo_item_participant_avatars_count', 3);
    $ucount = WPF()->post->get_users_count_for_forum($forumid);
    wpforo_l2_print_avatars(WPF()->post->get_userids_for_forum($forumid, $ulimit), $ucount);
}

function wpforo_l2_topic_users($topicid)
{
    $ulimit = (int) apply_filters('wpforo_item_participant_avatars_count', 3);
    $ucount = WPF()->post->get_users_count_for_topic($topicid);
    wpforo_l2_print_avatars(WPF()->post->get_userids_for_topic($topicid, $ulimit), $ucount);
}
